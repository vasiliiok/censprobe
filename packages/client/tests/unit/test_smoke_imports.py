"""Smoke-import: every censprobe_client submodule imports cleanly."""
...
import censprobe_client


def test_every_submodule_imports() -> None:
    failed: list[tuple[str, BaseException]] = []
    for module_info in pkgutil.walk_packages(censprobe_client.__path__, prefix="censprobe_client."):
        try:
