...
def _endpoint_from_ipapi(data: dict[str, Any]) -> EndpointMeta:
...
def detect_distro() -> str:
    ...
    # Falling back to platform.system() on any parse error keeps the meta
    # populated even on non-standard distros / minimal containers without
    # /etc/os-release.
