"""Tests for http._classify_connect_error and describe_exception.
...
class TestDescribeException:
    def test_uses_str_when_present(self) -> None:
        ...
        assert describe_exception(err) == "connection broke"
...
class TestClassifyConnectError:
    ...
    def test_ssl_branch_getsdescribe_exception_too(self) -> None:
    ...
    def test_rst_branch_getsdescribe_exception_too(self) -> None:
